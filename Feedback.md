...
|   ❌   | Na aanmelden kan de gebruiker zijn of haar gegevens opvragen.                                                                                                                                                                                                                       | Niet mogelijk om user gegevens te downloaden |    🟡    |
...
|   ❌   | Voor actieve resources van derden wordt SubResource Integrity (SRI) gebruikt.                                                                                                                                                                                 | Niet alle scripts maken gebruik van het integrity attribute                                                                            |    🔵    |
